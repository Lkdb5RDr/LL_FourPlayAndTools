...
;	Version 51 for runtime 1.10.984	2024 05 20 by jaam and Chosen Clue and EgoBallistic and Fedim
...
;;;; Send an event to an Actor's animation graph
;;;Function NotifyAnimationGraph(Actor akActor, String akEvent) native global
